...
def get_columns(schema: Optional[str] = None, table: Optional[str] = None, mock: bool = False) -> List[Dict[str, Any]]:
    ...
    if mock:
        return [
            {"TABSCHEMA": "TEST", "TABNAME": "USERS", "COLNAME": "ID", "DATA_TYPE": "INTEGER", "LENGTH": 4, "SCALE": 0, "ORDINAL_POSITION": 1, "REMARKS": "User ID", "IS_NULLABLE": "N"},
            {"TABSCHEMA": "TEST", "TABNAME": "USERS", "COLNAME": "NAME", "DATA_TYPE": "VARCHAR", "LENGTH": 100, "SCALE": 0, "ORDINAL_POSITION": 2, "REMARKS": "", "IS_NULLABLE": "Y"},
            {"TABSCHEMA": "TEST", "TABNAME": "ORDERS", "COLNAME": "ID", "DATA_TYPE": "INTEGER", "LENGTH": 4, "SCALE": 0, "ORDINAL_POSITION": 1, "REMARKS": "Order ID", "IS_NULLABLE": "N"},
            {"TABSCHEMA": "TEST", "TABNAME": "ORDERS", "COLNAME": "USER_ID", "DATA_TYPE": "INTEGER", "LENGTH": 4, "SCALE": 0, "ORDINAL_POSITION": 2, "REMARKS": "FK to USERS", "IS_NULLABLE": "Y"},
            {"TABSCHEMA": "TEST", "TABNAME": "ORDERS", "COLNAME": "PRODUCT_ID", "DATA_TYPE": "INTEGER", "LENGTH": 4, "SCALE": 0, "ORDINAL_POSITION": 3, "REMARKS": "FK to PRODUCTS", "IS_NULLABLE": "Y"},
            {"TABSCHEMA": "TEST", "TABNAME": "PRODUCTS", "COLNAME": "ID", "DATA_TYPE": "INTEGER", "LENGTH": 4, "SCALE": 0, "ORDINAL_POSITION": 1, "REMARKS": "Product ID", "IS_NULLABLE": "N"},
        ]
...
def get_indexes(schema: Optional[str] = None, table: Optional[str] = None, mock: bool = False) -> List[Dict[str, Any]]:
    ...
    if mock:
        return [
            {"TABSCHEMA": "TEST", "TABNAME": "USERS", "INDEX_SCHEMA": "TEST", "INDEX_NAME": "IDX_USERS_ID", "COLUMN_NAME": "ID", "IS_UNIQUE": "Y", "ORDINAL_POSITION": 1},
            {"TABSCHEMA": "TEST", "TABNAME": "ORDERS", "INDEX_SCHEMA": "TEST", "INDEX_NAME": "IDX_ORDERS_USER_ID", "COLUMN_NAME": "USER_ID", "IS_UNIQUE": "N", "ORDINAL_POSITION": 1},
        ]
