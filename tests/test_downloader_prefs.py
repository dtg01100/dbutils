...
def test_save_prefs(tmp_path, monkeypatch):
    ...
    # Save preferences
    test_prefs = {"maven_repos": ["https://test.repo.com/maven2/"], "custom_setting": "test_value"}
...
def test_validate_repositories_mixed(tmp_path, monkeypatch):
    ...
    repos = ["https://repo1.maven.org/maven2/", "invalid-url", "https://another-valid-repo.com/", ""]
