...
class TestConfigurationLoading:
    ...
    def test_file_configuration_loading(self, tmp_path):
        ...
        test_config = {
            ...
            "network": {"maven_repositories": ["https://test.repo.com/maven2/"], "timeout": 60},
        }
    ...
    def test_environment_variable_loading(self, tmp_path):
        ...
        env_config = {
            ...
            "DBUTILS_TEST_NETWORK": json.dumps({"timeout": 120, "retry_attempts": 5}),
        }
    ...
    def test_configuration_priority(self, tmp_path):
        ...
        # Create config file
        file_config = {
            "databases": {"priority_test": {"driver_class": "org.file.Driver", "test_source": "file"}},
            "network": {"timeout": 30, "source": "file"},
        }
        ...
        env_config = {
            ...
            "DBUTILS_TEST_DATABASES": json.dumps(
                {"priority_test": {"driver_class": "org.env.Driver", "test_source": "env"}}
            ),
            "DBUTILS_TEST_NETWORK": json.dumps({"timeout": 60, "source": "env"}),
        }
...
class TestBackwardCompatibility:
    ...
    def test_environment_variable_fallback(self, tmp_path):
        ...
        file_config = {"databases": {"sqlite": {"driver_class": "org.sqlite.JDBC", "jar_path": "file_path.jar"}}}
        ...
        env_config = {
            "DBUTILS_TEST_CONFIG": str(config_file),
            "DBUTILS_TEST_DATABASES": json.dumps(
                {"sqlite": {"driver_class": "org.sqlite.JDBC", "jar_path": "env_path.jar"}}
            ),
        }
